...
import com.indigo.iam.mapper.OrganizationMapper;
import com.indigo.iam.service.OrganizationService;
...
public class OrganizationServiceImpl extends ServiceImpl<OrganizationMapper, Organization> implements OrganizationService {
    ...
    @Override
    public List<OrganizationTreeVO> getOrganizationTreeVO() {
        // 查询所有组织
        LambdaQueryWrapper<Organization> wrapper = new LambdaQueryWrapper<>();
        wrapper.orderByAsc(Organization::getOrderNum);
        ...
        // 转换为VO
        List<OrganizationTreeVO> orgVOs = organizations.stream()
                .map(org -> {
        ...
        return TreeBuilder.buildTree(
                ...
                OrganizationTreeVO::getParentId,
                OrganizationTreeVO::setChildren
        );
    }
