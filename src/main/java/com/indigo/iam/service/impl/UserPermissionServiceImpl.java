...
import com.indigo.iam.common.CacheKeyConstants;
import com.indigo.iam.dto.BatchUserPermissionAssignDTO;
import com.indigo.iam.dto.UserPermissionAssignDTO;
import com.indigo.iam.entity.Permission;
import com.indigo.iam.entity.Role;
import com.indigo.iam.entity.UserPermission;
import com.indigo.iam.mapper.UserPermissionMapper;
import com.indigo.iam.service.PermissionService;
import com.indigo.iam.service.RolePermissionService;
import com.indigo.iam.service.UserService;
import com.indigo.iam.service.UserPermissionService;
import com.indigo.iam.service.UserRoleService;
import com.indigo.iam.vo.UserAllPermissionsVO;
...
public class UserPermissionServiceImpl extends ServiceImpl<UserPermissionMapper, UserPermission> implements UserPermissionService {
    ...
    public boolean assignPermission(UserPermissionAssignDTO dto) {
        // 检查用户是否存在
        com.indigo.iam.entity.User user = userService.getById(dto.getUserId());
        if (user == null) {
